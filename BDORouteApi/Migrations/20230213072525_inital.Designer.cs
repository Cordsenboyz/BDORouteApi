...
namespace BDORouteApi.Migrations
{
    ...
    [Migration("20230213072525_inital")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BDORouteApi.Model.MobinstancePull", b =>
                {
                    b.Property<int>("MobinstanceId")
                        .HasColumnType("int");

                    b.Property<int>("PullId")
                        .HasColumnType("int");

                    b.HasKey("MobinstanceId", "PullId");

                    b.HasIndex("PullId");

                    b.ToTable("MobinstancePulls");
                });
            ...
            modelBuilder.Entity("BDORouteApi.Model.MobinstancePull", b =>
                {
                    b.HasOne("BDORouteApi.Model.Mobinstance", "Mobinstance")
                        .WithMany("MobinstancePulls")
                        .HasForeignKey("MobinstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BDORouteApi.Model.Pull", "Pull")
                        .WithMany("MobinstancePulls")
                        .HasForeignKey("PullId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Mobinstance");
